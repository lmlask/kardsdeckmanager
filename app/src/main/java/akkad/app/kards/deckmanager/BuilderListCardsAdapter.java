...
public class BuilderListCardsAdapter extends RecyclerView.Adapter<BuilderListCardsAdapter.ViewHolder>{

    private LinkedHashMap<Card, Integer> mCards;
    private Context mContext;

    public BuilderListCardsAdapter(LinkedHashMap<Card, Integer> mCards, Context mContext) {
        this.mCards = mCards;
