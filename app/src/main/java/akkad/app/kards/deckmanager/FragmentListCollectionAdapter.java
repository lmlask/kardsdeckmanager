...
public class FragmentListCollectionAdapter extends RecyclerView.Adapter<FragmentListCollectionAdapter.ViewHolder>{

    private LinkedHashMap<Card, Integer> mCards;
    private Context mContext;

    public FragmentListCollectionAdapter(LinkedHashMap<Card, Integer> mCards, Context mContext) {
        this.mCards = mCards;
