...
public class FragmentHeadlineCollectionAdapter extends RecyclerView.Adapter<FragmentHeadlineCollectionAdapter.ViewHolder>{

    private LinkedHashMap<Card, Integer> mCards;
    private Context mContext;

    public FragmentHeadlineCollectionAdapter(LinkedHashMap<Card, Integer> mCards, Context mContext) {
        this.mCards = mCards;
    ...
    public void onBindViewHolder(ViewHolder holder, final int position) {
        ...
        holder.parentLayout.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Log.d(TAG, "onClick: Clicked on " + c.getName());
