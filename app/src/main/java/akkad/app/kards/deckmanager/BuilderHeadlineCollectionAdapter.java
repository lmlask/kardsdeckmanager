...
public class BuilderHeadlineCollectionAdapter extends RecyclerView.Adapter<BuilderHeadlineCollectionAdapter.ViewHolder>{

    private LinkedHashMap<Card, Integer> mCards;
    private Context mContext;

    public BuilderHeadlineCollectionAdapter(LinkedHashMap<Card, Integer> mCards, Context mContext) {
        this.mCards = mCards;
